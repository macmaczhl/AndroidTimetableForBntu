...
public class CellLesson {
	...
	//6 - разделение по неделям, вторая подгруппа разделена - 3
	//7 - разделение по неделям, первая подгруппа разделена - 3
	...
	public void setTripleLessonSeparSecWeek(Lesson lesOne, Lesson lesTwo, Lesson lesThree)
	{
		isSortedFlag = true;
		typeOfCell = 3;
		setTripleLesson(lesOne, lesTwo, lesThree);
	}
	public void setTripleLessonSeparFirstWeek(Lesson lesOne, Lesson lesTwo, Lesson lesThree)
	{
		isSortedFlag = true;
		typeOfCell = 4;
		setTripleLesson(lesOne, lesTwo, lesThree);
	}
	public void setTripleLessonSeparSecGroup(Lesson lesOne, Lesson lesTwo, Lesson lesThree)
	{
		isSortedFlag = true;
		typeOfCell = 6;
		setTripleLesson(lesOne, lesTwo, lesThree);
	}
	public void setTripleLessonSeparFirstGroup(Lesson lesOne, Lesson lesTwo, Lesson lesThree)
	{
		isSortedFlag = true;
		typeOfCell = 7;
		setTripleLesson(lesOne, lesTwo, lesThree);
	...
	{
		if (isSortedFlag == true && (typeOfCell == 3 || typeOfCell == 4 || typeOfCell == 6 || typeOfCell == 7))
			return tripleLesson;
		else
			return null;
	}
	...
	//Четыре предмета
	public void setFourLesson(Lesson lesOne, Lesson lesTwo, Lesson lesThree, Lesson lesFour)
	{
		isSortedFlag = true;
		typeOfCell = 5;
